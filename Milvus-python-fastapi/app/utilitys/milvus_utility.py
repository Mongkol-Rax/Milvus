...
class MilvusUtility:
    ...
    def insert_data(self, collection_name, data):
        ...
        if not utility.has_collection(collection_name):
            check_collection = f"Collection '{collection_name}' does not exist."
        ...
        try:
            ...
            except_log = f"Error inserting data into collection '{collection_name}': {e}"
            print(except_log)
            return except_log
    ...
    def search_by_guid(self, collection_name, id_list):
        ...
        try:
            ...
            # ค้นหาข้อมูล
            results = collection.query(expr=expr, output_fields=["id", "text"])
    ...
    def search_by_int(self, collection_name, randomint_values):
        ...
        try:
            ...
            # ค้นหาข้อมูล
            results = collection.query(expr=expr, output_fields=["id", "text", "randomint"])
